...
<%@ include file ="/WEB-INF/views/common/containerBar.jsp"%>
         ...
         <div class="VEGAN">
            <a href="<%=request.getContextPath() %>/community/enviroment2"> <img src="<%=request.getContextPath() %>/image/커뮤니티/이동수단.png" alt="" style="width: 40vw"></a>
            <h1 style="font-style: italic; color: #00008B;">내 차마련, 괜찮지않아요.</h1>
        </div>
 <div class="img"></div>
       	<div class="Paging">
            <a href="#">
