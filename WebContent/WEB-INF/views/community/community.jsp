...
<%@ include file ="/WEB-INF/views/common/containerBar.jsp"%>
        <div class="VEGAN">
            <a href="<%=request.getContextPath() %>/community/enviroment1"> <img src="<%=request.getContextPath() %>/image/커뮤니티/식품.png" alt="" style="width: 40vw"></a>
            <h1 style="font-style: italic; color: #00008B;">환경에 착하지 않은 음식들</h1>
        </div>
<!--         <div class="WATE">
            <a href="enviorment(list2).html">
                <img src="image/커뮤니티/제로웨이스트.png" alt="">
            </a>
            <br>
            <h1 style="font-style: italic;">제로웨이스트</h1>
        </div> -->
        <div class="img"></div>
       	<div class="Paging">
            <a href="#">
