...
/**
 * Servlet implementation class ConfirmDayListServlet
 */
@WebServlet("/community/confirmDayList")
public class ConfirmDayListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			request.getRequestDispatcher("/WEB-INF/views/community/confirmDayList.jsp")
