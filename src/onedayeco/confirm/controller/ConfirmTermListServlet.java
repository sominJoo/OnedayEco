...
/**
 * Servlet implementation class ConfirmTermListServlet
 */
@WebServlet("/community/confirmTermList")
public class ConfirmTermListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//0. 인코딩처리는 EncodingFilter가 선처리 
				...
				request.getRequestDispatcher("/WEB-INF/views/community/confirmTermList.jsp")
