...
/**
 * Servlet implementation class CommunityCommunityListServlet
 */
@WebServlet("/community/communityCommunityList")
public class CommunityCommunityListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//0. 인코딩처리는 EncodingFilter가 선처리 
				...
				request.getRequestDispatcher("/WEB-INF/views/community/communityBoardListCommunity.jsp")
