...
/**
 * Servlet implementation class CommunityBoardDelete
 */
@WebServlet("/community/communitytBoardDelete")
    ...
    /**
   	...
   	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
   		try {
   			...
   			//2. 업무로직 : db에 delete
   			int result = articleService.deleteBoard(no);
   			String msg = (result > 0)? "게시글 삭제 성공!" : "게시글 삭제 실패";
   			String location = request.getContextPath();
   			location += result>0?  "/community/communityBoardList": "/community/communityBoardView?no=" + no;
