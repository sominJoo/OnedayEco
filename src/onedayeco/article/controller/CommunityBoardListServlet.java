 ...
 */
@WebServlet("/community/communityBoardList")
public class CommunityBoardListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//0. 인코딩처리는 EncodingFilter가 선처리 
				...
				//b. pageBar영역 
				int totalContents = articleService.selectBoardCount();
				...
				request.getRequestDispatcher("/WEB-INF/views/community/communityBoardList.jsp")
