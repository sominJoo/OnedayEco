...
/**
 * Servlet implementation class TeamMemberboardLikeServlet
 */
@WebServlet("/community/teamMemberboardLike")
public class TeamMemberboardLikeServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			teamMemberboardService.updateTeamMemberboardLike(no);
